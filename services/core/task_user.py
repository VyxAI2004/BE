...
class TaskUserService(
    BaseService[TaskUser, TaskUserCreate, TaskUserUpdate, TaskUserRepository]
):
    ...
    def get_task_collaborators(
        ...
        return self.repository.get_task_collaborators(
            task_id, skip, limit, is_active_only
        )
    ...
    def get_user_tasks_as_collaborator(
        ...
        return self.repository.get_user_tasks_as_collaborator(
            user_id, skip, limit, is_active_only
        )
    ...
    def can_user_edit_task_as_collaborator(
